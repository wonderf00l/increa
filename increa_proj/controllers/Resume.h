...
class Resume : public drogon::HttpController<Resume> {
   public:
    ...
    // METHOD_ADD(Resume::get, "/{2}/{1}", Get); // path is /Resume/{arg2}/{arg1}
    // METHOD_ADD(Resume::your_method_name, "/{1}/{2}/list", Get); // path is
    // /Resume/{arg1}/{arg2}/list ADD_METHOD_TO(Resume::your_method_name,
